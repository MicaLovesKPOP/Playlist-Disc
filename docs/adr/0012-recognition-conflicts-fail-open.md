# ADR 0012: Valid recognition-channel disagreement always fails open
...
A priority rule such as 'TOC always wins' would make a corruption, stale metadata field, or adapter decoding bug look like a valid disc selection whenever another channel disagreed.
